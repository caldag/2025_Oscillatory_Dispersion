...
// LIC//
// LIC//====================================================================
#include "refineable_gen_advection_diffusion_elements_time_wind.h"
...
namespace oomph
{
  ...
  void RefineableGeneralisedAdvectionDiffusionEquationsTimeWind<DIM>::
  ...
  //====================================================================
  template class RefineableQGeneralisedAdvectionDiffusionElementTimeWind<2, 2>;
  template class RefineableQGeneralisedAdvectionDiffusionElementTimeWind<2, 3>;
  template class RefineableQGeneralisedAdvectionDiffusionElementTimeWind<2, 4>;

  template class RefineableQGeneralisedAdvectionDiffusionElementTimeWind<3, 2>;
  template class RefineableQGeneralisedAdvectionDiffusionElementTimeWind<3, 3>;
  template class RefineableQGeneralisedAdvectionDiffusionElementTimeWind<3, 4>;
