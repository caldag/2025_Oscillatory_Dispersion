...
// names edited
#ifndef OOMPH_REFINEABLE_GEN_ADVECTION_DIFFUSION_ELEMENTS_TIME_WIND_HEADER
#define OOMPH_REFINEABLE_GEN_ADVECTION_DIFFUSION_ELEMENTS_TIME_WIND_HEADER
...
#include "gen_advection_diffusion_elements_time_wind.h" // changed this include
...
namespace oomph
{
  ...
  class RefineableGeneralisedAdvectionDiffusionEquationsTimeWind
  ...
  public:
    /// Empty Constructor
    RefineableGeneralisedAdvectionDiffusionEquationsTimeWind()
      : GeneralisedAdvectionDiffusionEquationsTimeWind<DIM>(),
        RefineableElement(),
    ...
    RefineableGeneralisedAdvectionDiffusionEquationsTimeWind(
      const RefineableGeneralisedAdvectionDiffusionEquationsTimeWind<DIM>& dummy) =
      delete;

    /// Broken assignment operator
    void operator=(
      const RefineableGeneralisedAdvectionDiffusionEquationsTimeWind<DIM>&) = delete;
    ...
    void further_build()
    {
      RefineableGeneralisedAdvectionDiffusionEquationsTimeWind<DIM>*
        cast_father_element_pt =
          dynamic_cast<RefineableGeneralisedAdvectionDiffusionEquationsTimeWind<DIM>*>(
  ...
  //======================================================================
  /// Refineable version of QGeneralisedAdvectionDiffusionElementTimeWind.
  /// Inherit from the standard QGeneralisedAdvectionDiffusionElementTimeWind and the
  /// appropriate refineable geometric element and the refineable equations.
  //======================================================================
  template<unsigned DIM, unsigned NNODE_1D>
  class RefineableQGeneralisedAdvectionDiffusionElementTimeWind
    : public QGeneralisedAdvectionDiffusionElementTimeWind<DIM, NNODE_1D>,
      public virtual RefineableGeneralisedAdvectionDiffusionEquationsTimeWind<DIM>,
      public virtual RefineableQElement<DIM>
  {
  public:
    /// Empty Constructor:
    RefineableQGeneralisedAdvectionDiffusionElementTimeWind()
      : RefineableElement(),
        RefineableGeneralisedAdvectionDiffusionEquationsTimeWind<DIM>(),
        RefineableQElement<DIM>(),
        QGeneralisedAdvectionDiffusionElementTimeWind<DIM, NNODE_1D>()
    {
    }
    ...
    /// Broken copy constructor
    RefineableQGeneralisedAdvectionDiffusionElementTimeWind(
      const RefineableQGeneralisedAdvectionDiffusionElementTimeWind<DIM, NNODE_1D>&
        dummy) = delete;
    ...
    {
      return QGeneralisedAdvectionDiffusionElementTimeWind<DIM,
  ...
  /// RefineableQuadGeneralisedAdvectionDiffusionElementTimeWind elements: The spatial
  ...
  template<unsigned DIM, unsigned NNODE_1D>
  class FaceGeometry<
    RefineableQGeneralisedAdvectionDiffusionElementTimeWind<DIM, NNODE_1D>>
