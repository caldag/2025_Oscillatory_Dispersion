...
#include "gen_advection_diffusion_elements_time_wind.h"
...
namespace oomph
{
  ...
  double GeneralisedAdvectionDiffusionEquationsTimeWind<DIM>::Default_peclet_number =
    0.0;
  ...
  //======================================================================
  template<unsigned DIM>
  void GeneralisedAdvectionDiffusionEquationsTimeWind<DIM>::
  ...
  //======================================================================
  template<unsigned DIM>
  unsigned GeneralisedAdvectionDiffusionEquationsTimeWind<DIM>::self_test()
  {
    bool passed = true;
  ...
  //======================================================================
  template<unsigned DIM>
  void GeneralisedAdvectionDiffusionEquationsTimeWind<DIM>::output(
  ...
  //======================================================================
  template<unsigned DIM>
  void GeneralisedAdvectionDiffusionEquationsTimeWind<DIM>::output_fct(
    std::ostream& outfile,
  ...
  //======================================================================
  template<unsigned DIM>
  void GeneralisedAdvectionDiffusionEquationsTimeWind<DIM>::compute_error(
    std::ostream& outfile,
    FiniteElement::SteadyExactSolutionFctPt exact_soln_pt,
    double& error,
    double& norm)
  ...
  //======================================================================
  template<unsigned DIM>
  double GeneralisedAdvectionDiffusionEquationsTimeWind<DIM>::integrate_u()
  {
    // Initialise
    double sum = 0.0;
  ...
  const unsigned
    QGeneralisedAdvectionDiffusionElementTimeWind<DIM, NNODE_1D>::Initial_Nvalue = 1;

  //====================================================================
  // Force build of templates
  //====================================================================
  template class GeneralisedAdvectionDiffusionEquationsTimeWind<1>;
  template class GeneralisedAdvectionDiffusionEquationsTimeWind<2>;
  template class GeneralisedAdvectionDiffusionEquationsTimeWind<3>;

  template class QGeneralisedAdvectionDiffusionElementTimeWind<1, 2>;
  template class QGeneralisedAdvectionDiffusionElementTimeWind<1, 3>;
  template class QGeneralisedAdvectionDiffusionElementTimeWind<1, 4>;

  template class QGeneralisedAdvectionDiffusionElementTimeWind<2, 2>;
  template class QGeneralisedAdvectionDiffusionElementTimeWind<2, 3>;
  template class QGeneralisedAdvectionDiffusionElementTimeWind<2, 4>;

  template class QGeneralisedAdvectionDiffusionElementTimeWind<3, 2>;
  template class QGeneralisedAdvectionDiffusionElementTimeWind<3, 3>;
  template class QGeneralisedAdvectionDiffusionElementTimeWind<3, 4>;
