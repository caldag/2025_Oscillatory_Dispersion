...
#ifndef OOMPH_GEN_ADV_DIFF_ELEMENTS_TIME_WIND_HEADER
#define OOMPH_GEN_ADV_DIFF_ELEMENTS_TIME_WIND_HEADER
...
namespace oomph
{
  ...
  /// \f[ \frac{\partial}{\partial x_{i}}\left( Pe w_{i}(x_{k}) u - D_{ij}(x_{k})\frac{\partial u}{\partial x_{j}}\right) = f(x_{j}) \f]
  /// This contains the generic maths. Shape functions, geometric
  /// mapping etc. must get implemented in derived class.
  //=============================================================
  template<unsigned DIM>
  class GeneralisedAdvectionDiffusionEquationsTimeWind : public virtual FiniteElement
  {
  public:
    ...
    typedef void (*GeneralisedAdvectionDiffusionDiffFctPt)(
      const Vector<double>& x, double& tval, DenseMatrix<double>& D);
      
    typedef oomph::Time (*GeneralisedAdvectionDiffusionTimeFctPt);

    /// Constructor: Initialise the Source_fct_pt and Wind_fct_pt
    /// to null and set (pointer to) Peclet number to default
    GeneralisedAdvectionDiffusionEquationsTimeWind()
      : Source_fct_pt(0),
        Wind_fct_pt(0),
    ...
    GeneralisedAdvectionDiffusionEquationsTimeWind(
      const GeneralisedAdvectionDiffusionEquationsTimeWind& dummy) = delete;

    /// Broken assignment operator
    void operator=(const GeneralisedAdvectionDiffusionEquationsTimeWind&) = delete;
    ...
    GeneralisedAdvectionDiffusionTimeFctPt& time_fct_pt()
    {
      return Time_fct_pt;
    }

    GeneralisedAdvectionDiffusionTimeFctPt time_fct_pt() const
    {
      return Time_fct_pt;
    }
    ...
    /// Access function: Pointer to additoinal (conservative)
    /// wind function.
    /// Const version
      ...
      Vector<double>& wind) const
    {
      ...
      else
      {
         double tval=Time_fct_pt->time();
        // Get wind
        (*Conserved_wind_fct_pt)(x, tval, wind);
      }
    }
  ...
  //======================================================================
  /// QGeneralisedAdvectionDiffusionElementTimeWind elements are
  /// linear/quadrilateral/brick-shaped Advection Diffusion elements with
  /// isoparametric interpolation for the function.
  //======================================================================
  template<unsigned DIM, unsigned NNODE_1D>
  class QGeneralisedAdvectionDiffusionElementTimeWind
    : public virtual QElement<DIM, NNODE_1D>,
      public virtual GeneralisedAdvectionDiffusionEquationsTimeWind<DIM>
  {
  private:
  ...
  public:
    ...
    QGeneralisedAdvectionDiffusionElementTimeWind()
      : QElement<DIM, NNODE_1D>(), GeneralisedAdvectionDiffusionEquationsTimeWind<DIM>()
    {
    }

    /// Broken copy constructor
    QGeneralisedAdvectionDiffusionElementTimeWind(
      const QGeneralisedAdvectionDiffusionElementTimeWind<DIM, NNODE_1D>& dummy) =
      delete;

    /// Broken assignment operator
    void operator=(
      const QGeneralisedAdvectionDiffusionElementTimeWind<DIM, NNODE_1D>&) = delete;
    ...
    void output(std::ostream& outfile)
    {
      GeneralisedAdvectionDiffusionEquationsTimeWind<DIM>::output(outfile);
    }
    ...
    {
      GeneralisedAdvectionDiffusionEquationsTimeWind<DIM>::output(outfile, n_plot);
    }
    ...
    void output(FILE* file_pt)
    {
      GeneralisedAdvectionDiffusionEquationsTimeWind<DIM>::output(file_pt);
    }
    ...
    void output(FILE* file_pt, const unsigned& n_plot)
    {
      GeneralisedAdvectionDiffusionEquationsTimeWind<DIM>::output(file_pt, n_plot);
    }
    ...
    void output_fct(std::ostream& outfile,
                    ...
                    FiniteElement::SteadyExactSolutionFctPt exact_soln_pt)
    {
      GeneralisedAdvectionDiffusionEquationsTimeWind<DIM>::output_fct(
  ...
  //======================================================================
  template<unsigned DIM, unsigned NNODE_1D>
  double QGeneralisedAdvectionDiffusionElementTimeWind<DIM, NNODE_1D>::
  ...
  //=======================================================================
  /// Face geometry for the QGeneralisedAdvectionDiffusionElementTimeWind
  ...
  //=======================================================================
  template<unsigned DIM, unsigned NNODE_1D>
  class FaceGeometry<QGeneralisedAdvectionDiffusionElementTimeWind<DIM, NNODE_1D>>
  ...
  class FaceGeometry<QGeneralisedAdvectionDiffusionElementTimeWind<1, NNODE_1D>>
